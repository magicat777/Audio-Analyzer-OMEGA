...
class ProfessionalLiveAudioAnalyzer:
    ...
    def _register_panel_updates(self):
        ...
        self.panel_update_manager.register_panel('vu_meters', 
            lambda *args, **kwargs: self.vu_meters_panel.update(*args) if not self.frozen_vu_meters else None)
        ...
        self.panel_update_manager.register_panel('bass_zoom',
            lambda *args, **kwargs: self.bass_zoom_panel.update(*args) if not self.frozen_bass_zoom else None)
